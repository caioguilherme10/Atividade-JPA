...
@Entity
public class Aluno extends PessoaUm implements Serializable{
    ...
    public Aluno(String nome, String cpf, Integer idade, Endereco endereco, LocalDate dataNasc, String matricula, LocalDate dataIngresso, String turma) {
